...
#
# Script generated by Vivado on Sun Apr 14 16:58:38 +0200 2024
...
#
# Usage        : rgb2ycbcr_0.sh
#                rgb2ycbcr_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rgb2ycbcr_0.sh [-reset_run]
#                rgb2ycbcr_0.sh [-reset_log]
#                rgb2ycbcr_0.sh [-help]
#
...
#                script (type 'rgb2ycbcr_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_11 -libname c_reg_fd_v12_0_7 -libname xbip_dsp48_wrapper_v3_0_5 -libname xbip_pipe_v3_0_7 -libname xbip_dsp48_addsub_v3_0_7 -libname xbip_addsub_v3_0_7 -libname c_addsub_v12_0_16 -libname xil_defaultlib -libname xbip_bram18k_v3_0_7 -libname mult_gen_v12_0_19 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_11 c_reg_fd_v12_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_pipe_v3_0_7 xbip_dsp48_addsub_v3_0_7 xbip_addsub_v3_0_7 c_addsub_v12_0_16 xil_defaultlib xbip_bram18k_v3_0_7 mult_gen_v12_0_19)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "rgb2ycbcr_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rgb2ycbcr_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.rgb2ycbcr_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.rgb2ycbcr_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log rgb2ycbcr_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: rgb2ycbcr_0.sh [-step]\n\
Usage: rgb2ycbcr_0.sh [-lib_map_path]\n\
Usage: rgb2ycbcr_0.sh [-reset_run]\n\
Usage: rgb2ycbcr_0.sh [-reset_log]\n\
Usage: rgb2ycbcr_0.sh [-keep_index]\n\
