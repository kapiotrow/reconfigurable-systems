...
#
# Script generated by Vivado on Sun Apr 14 16:48:08 +0200 2024
...
#
# Usage        : LUT.sh
#                LUT.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                LUT.sh [-reset_run]
#                LUT.sh [-reset_log]
#                LUT.sh [-help]
#
...
# script info
echo -e "LUT.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./LUT.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot LUT xil_defaultlib.LUT xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim LUT -key {Behavioral:sim_1:Functional:LUT} -tclbatch cmd.tcl -protoinst "protoinst_files/hdmi_vga.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb LUT.wdb xsim.dir libdpi.so)
...
Usage: LUT.sh [-reset_log]\n\
Usage: LUT.sh [-keep_index]\n\
