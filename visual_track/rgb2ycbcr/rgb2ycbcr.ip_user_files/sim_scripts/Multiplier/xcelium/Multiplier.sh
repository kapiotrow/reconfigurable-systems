...
#
# Script generated by Vivado on Sat Apr 13 15:30:08 +0200 2024
...
#
# Usage        : Multiplier.sh
#                Multiplier.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Multiplier.sh [-reset_run]
#                Multiplier.sh [-reset_log]
#                Multiplier.sh [-help]
#
...
#                script (type 'Multiplier.sh -help' for more information).
#
...
# script info
echo -e "Multiplier.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Multiplier.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.Multiplier
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.Multiplier -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Multiplier_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: Multiplier.sh [-step]\n\
Usage: Multiplier.sh [-lib_map_path]\n\
Usage: Multiplier.sh [-reset_run]\n\
Usage: Multiplier.sh [-reset_log]\n\
Usage: Multiplier.sh [-keep_index]\n\
