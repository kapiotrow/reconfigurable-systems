...
#
# Script generated by Vivado on Wed May 15 20:22:58 +0200 2024
...
#
# Usage        : delayLineBRAM.sh
#                delayLineBRAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                delayLineBRAM.sh [-reset_run]
#                delayLineBRAM.sh [-reset_log]
#                delayLineBRAM.sh [-help]
#
...
# script info
echo -e "delayLineBRAM.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./delayLineBRAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot delayLineBRAM xil_defaultlib.delayLineBRAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim delayLineBRAM -key {Behavioral:sim_1:Functional:delayLineBRAM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb delayLineBRAM.wdb xsim.dir libdpi.so)
...
Usage: delayLineBRAM.sh [-step]\n\
Usage: delayLineBRAM.sh [-lib_map_path]\n\
Usage: delayLineBRAM.sh [-reset_run]\n\
Usage: delayLineBRAM.sh [-reset_log]\n\
Usage: delayLineBRAM.sh [-keep_index]\n\
