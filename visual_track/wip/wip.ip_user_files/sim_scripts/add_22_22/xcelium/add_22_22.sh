...
#
# Script generated by Vivado on Sun May 05 18:17:07 +0200 2024
# SW Build 4126759 on Thu Feb  8 23:53:51 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : add_22_22.sh
...
#
# Usage        : add_22_22.sh
#                add_22_22.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                add_22_22.sh [-reset_run]
#                add_22_22.sh [-reset_log]
#                add_22_22.sh [-help]
#
...
#                script (type 'add_22_22.sh -help' for more information).
#
...
# script info
echo -e "add_22_22.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./add_22_22.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.add_22_22 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.add_22_22 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log add_22_22_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./add_22_22.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: add_22_22.sh [-help]\n\
Usage: add_22_22.sh [-step]\n\
Usage: add_22_22.sh [-lib_map_path]\n\
Usage: add_22_22.sh [-reset_run]\n\
Usage: add_22_22.sh [-reset_log]\n\
Usage: add_22_22.sh [-keep_index]\n\
Usage: add_22_22.sh [-noclean_files]\n\n\
