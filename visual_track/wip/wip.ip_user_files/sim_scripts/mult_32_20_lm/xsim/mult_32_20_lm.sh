...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_12 -L xbip_pipe_v3_0_8 -L xbip_bram18k_v3_0_8 -L mult_gen_v12_0_20 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mult_32_20_lm xil_defaultlib.mult_32_20_lm xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult_32_20_lm -key {Behavioral:sim_1:Functional:mult_32_20_lm} -tclbatch cmd.tcl -protoinst "protoinst_files/hdmi_vga.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xbip_utils_v3_0_12 xbip_pipe_v3_0_8 xbip_bram18k_v3_0_8 mult_gen_v12_0_20)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mult_32_20_lm.wdb xsim.dir libdpi.so)
