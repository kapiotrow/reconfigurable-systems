...
#
# Script generated by Vivado on Mon Apr 15 11:06:23 +0200 2024
...
#
# Usage        : hdmi_vga.sh
#                hdmi_vga.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                hdmi_vga.sh [-reset_run]
#                hdmi_vga.sh [-reset_log]
#                hdmi_vga.sh [-help]
#
...
#                script (type 'hdmi_vga.sh -help' for more information).
#
...
# script info
echo -e "hdmi_vga.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./hdmi_vga.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../treshold_YCbCr.gen/sources_1/bd/hdmi_vga/ipshared/c2c6" +incdir+"../../../../treshold_YCbCr.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_pixclk/hdl/verilog" +incdir+"../../../../treshold_YCbCr.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_refclk/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../treshold_YCbCr.gen/sources_1/bd/hdmi_vga/ipshared/c2c6" +incdir+"../../../../treshold_YCbCr.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_pixclk/hdl/verilog" +incdir+"../../../../treshold_YCbCr.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_refclk/hdl/verilog" \
  ...
  xmvlog -work xlconstant_v1_1_8 $xmvlog_opts +incdir+"../../../../treshold_YCbCr.gen/sources_1/bd/hdmi_vga/ipshared/c2c6" +incdir+"../../../../treshold_YCbCr.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_pixclk/hdl/verilog" +incdir+"../../../../treshold_YCbCr.gen/sources_1/bd/hdmi_vga/ip/hdmi_vga_dvi2rgb_0_0/src/ila_refclk/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.hdmi_vga xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.hdmi_vga -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log hdmi_vga_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: hdmi_vga.sh [-step]\n\
Usage: hdmi_vga.sh [-lib_map_path]\n\
Usage: hdmi_vga.sh [-reset_run]\n\
Usage: hdmi_vga.sh [-reset_log]\n\
Usage: hdmi_vga.sh [-keep_index]\n\
