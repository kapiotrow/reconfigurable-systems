...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.adder11_9 xil_defaultlib.glbl -o adder11_9_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./adder11_9_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key adder11_9_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc adder11_9_simv.daidir vcs_lib c.obj)
