...
#
# Script generated by Vivado on Mon Apr 29 09:56:40 +0200 2024
# SW Build 4126759 on Thu Feb  8 23:53:51 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mult_32_20_lm.sh
...
#
# Usage        : mult_32_20_lm.sh
#                mult_32_20_lm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mult_32_20_lm.sh [-reset_run]
#                mult_32_20_lm.sh [-reset_log]
#                mult_32_20_lm.sh [-help]
#
...
#                script (type 'mult_32_20_lm.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_12 -libname xbip_pipe_v3_0_8 -libname xbip_bram18k_v3_0_8 -libname mult_gen_v12_0_20 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_12 xbip_pipe_v3_0_8 xbip_bram18k_v3_0_8 mult_gen_v12_0_20 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "mult_32_20_lm.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mult_32_20_lm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mult_32_20_lm xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mult_32_20_lm -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mult_32_20_lm_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mult_32_20_lm.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mult_32_20_lm.sh [-help]\n\
Usage: mult_32_20_lm.sh [-step]\n\
Usage: mult_32_20_lm.sh [-lib_map_path]\n\
Usage: mult_32_20_lm.sh [-reset_run]\n\
Usage: mult_32_20_lm.sh [-reset_log]\n\
Usage: mult_32_20_lm.sh [-keep_index]\n\
Usage: mult_32_20_lm.sh [-noclean_files]\n\n\
