...
map_local_libs()
{
  ...
  local_libs=(xbip_utils_v3_0_11 c_reg_fd_v12_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_pipe_v3_0_7 xbip_dsp48_addsub_v3_0_7 xbip_addsub_v3_0_7 c_addsub_v12_0_16 xbip_bram18k_v3_0_7 mult_gen_v12_0_19)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rgb2ycbcr_0.wdb xsim.dir libdpi.so)
