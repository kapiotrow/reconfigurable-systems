...
HD_PWD='C:/Users/karol/Documents/studia/sem6/reconfigurable-systems/lab2/and_gate_cascade/and_gate_cascade.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cascade.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cascade.tcl
