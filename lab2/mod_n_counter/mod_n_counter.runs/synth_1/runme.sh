...
HD_PWD='C:/Users/karol/Documents/studia/sem6/reconfigurable-systems/lab2/mod_n_counter/mod_n_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mod_cntr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mod_cntr.tcl
