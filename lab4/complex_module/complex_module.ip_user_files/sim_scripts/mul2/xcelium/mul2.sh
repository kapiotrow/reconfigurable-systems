...
#
# Script generated by Vivado on Sat Mar 23 22:16:26 +0100 2024
...
#
# Usage        : mul2.sh
#                mul2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mul2.sh [-reset_run]
#                mul2.sh [-reset_log]
#                mul2.sh [-help]
#
...
#                script (type 'mul2.sh -help' for more information).
#
...
# script info
echo -e "mul2.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mul2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mul2
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mul2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mul2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mul2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mul2.sh [-help]\n\
Usage: mul2.sh [-step]\n\
Usage: mul2.sh [-lib_map_path]\n\
Usage: mul2.sh [-reset_run]\n\
Usage: mul2.sh [-reset_log]\n\
Usage: mul2.sh [-keep_index]\n\
Usage: mul2.sh [-noclean_files]\n\n\
