...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_12 -L xbip_pipe_v3_0_8 -L xbip_bram18k_v3_0_8 -L mult_gen_v12_0_20 -L xil_defaultlib -L secureip -L xpm --snapshot mul2 xil_defaultlib.mul2 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mul2 -key {Behavioral:sim_1:Functional:mul2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mul2.wdb xsim.dir libdpi.so)
