...
design_libs=(xbip_utils_v3_0_12 xbip_pipe_v3_0_8 xbip_bram18k_v3_0_8 mult_gen_v12_0_20 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mul2 -o mul2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mul2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mul2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mul2_simv.daidir vcs_lib c.obj)
