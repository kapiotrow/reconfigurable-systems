...
#
# Script generated by Vivado on Sat Mar 23 22:09:32 +0100 2024
...
#
# Usage        : mul1.sh
#                mul1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mul1.sh [-reset_run]
#                mul1.sh [-reset_log]
#                mul1.sh [-help]
#
...
#                script (type 'mul1.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_12 -libname xbip_pipe_v3_0_8 -libname xbip_bram18k_v3_0_8 -libname mult_gen_v12_0_20 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_12 xbip_pipe_v3_0_8 xbip_bram18k_v3_0_8 mult_gen_v12_0_20 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "mul1.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mul1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mul1
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mul1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mul1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mul1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mul1.sh [-help]\n\
Usage: mul1.sh [-step]\n\
Usage: mul1.sh [-lib_map_path]\n\
Usage: mul1.sh [-reset_run]\n\
Usage: mul1.sh [-reset_log]\n\
Usage: mul1.sh [-keep_index]\n\
Usage: mul1.sh [-noclean_files]\n\n\
