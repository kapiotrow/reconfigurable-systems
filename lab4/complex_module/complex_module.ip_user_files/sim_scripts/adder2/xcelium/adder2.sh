...
#
# Script generated by Vivado on Sun Mar 24 20:41:15 +0100 2024
...
#
# Usage        : adder2.sh
#                adder2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                adder2.sh [-reset_run]
#                adder2.sh [-reset_log]
#                adder2.sh [-help]
#
...
#                script (type 'adder2.sh -help' for more information).
#
...
# script info
echo -e "adder2.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./adder2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.adder2
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.adder2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log adder2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: adder2.sh [-step]\n\
Usage: adder2.sh [-lib_map_path]\n\
Usage: adder2.sh [-reset_run]\n\
Usage: adder2.sh [-reset_log]\n\
Usage: adder2.sh [-keep_index]\n\
