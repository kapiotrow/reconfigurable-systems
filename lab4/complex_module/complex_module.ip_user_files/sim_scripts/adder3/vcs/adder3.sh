...
design_libs=(xbip_utils_v3_0_12 c_reg_fd_v12_0_8 xbip_dsp48_wrapper_v3_0_5 xbip_pipe_v3_0_8 xbip_dsp48_addsub_v3_0_8 xbip_addsub_v3_0_8 c_addsub_v12_0_17 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.adder3 -o adder3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./adder3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key adder3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc adder3_simv.daidir vcs_lib c.obj)
