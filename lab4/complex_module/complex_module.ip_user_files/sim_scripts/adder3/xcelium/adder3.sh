...
#
# Script generated by Vivado on Sun Mar 24 20:41:57 +0100 2024
...
#
# Usage        : adder3.sh
#                adder3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                adder3.sh [-reset_run]
#                adder3.sh [-reset_log]
#                adder3.sh [-help]
#
...
#                script (type 'adder3.sh -help' for more information).
#
...
# script info
echo -e "adder3.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./adder3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.adder3
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.adder3 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log adder3_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./adder3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: adder3.sh [-help]\n\
Usage: adder3.sh [-step]\n\
Usage: adder3.sh [-lib_map_path]\n\
Usage: adder3.sh [-reset_run]\n\
Usage: adder3.sh [-reset_log]\n\
Usage: adder3.sh [-keep_index]\n\
Usage: adder3.sh [-noclean_files]\n\n\
