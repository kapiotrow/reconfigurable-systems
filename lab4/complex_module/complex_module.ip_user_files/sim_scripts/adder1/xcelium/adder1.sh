...
#
# Script generated by Vivado on Sun Mar 24 20:40:17 +0100 2024
...
#
# Usage        : adder1.sh
#                adder1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                adder1.sh [-reset_run]
#                adder1.sh [-reset_log]
#                adder1.sh [-help]
#
...
#                script (type 'adder1.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_12 -libname c_reg_fd_v12_0_8 -libname xbip_dsp48_wrapper_v3_0_5 -libname xbip_pipe_v3_0_8 -libname xbip_dsp48_addsub_v3_0_8 -libname xbip_addsub_v3_0_8 -libname c_addsub_v12_0_17 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_12 c_reg_fd_v12_0_8 xbip_dsp48_wrapper_v3_0_5 xbip_pipe_v3_0_8 xbip_dsp48_addsub_v3_0_8 xbip_addsub_v3_0_8 c_addsub_v12_0_17 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "adder1.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./adder1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.adder1
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.adder1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log adder1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./adder1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: adder1.sh [-help]\n\
Usage: adder1.sh [-step]\n\
Usage: adder1.sh [-lib_map_path]\n\
Usage: adder1.sh [-reset_run]\n\
Usage: adder1.sh [-reset_log]\n\
Usage: adder1.sh [-keep_index]\n\
Usage: adder1.sh [-noclean_files]\n\n\
