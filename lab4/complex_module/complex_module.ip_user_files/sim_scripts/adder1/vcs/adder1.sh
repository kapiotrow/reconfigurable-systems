...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.adder1 -o adder1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./adder1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key adder1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc adder1_simv.daidir vcs_lib c.obj)
